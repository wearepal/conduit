...
from bolts.data.datasets.audio.ecoacoustics import Ecoacoustics
from bolts.data.structures import TrainValTestSplit

from .base import PBAudioDataModule

__all__ = ["EcoacousticsDataModule"]


class EcoacousticsDataModule(PBAudioDataModule):
